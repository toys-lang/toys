...
public class Parsers {
    ...
    public static Parser<Character, Ast.IntegerLiteral> integer = intr.map(Ast::integerLiteral).bind(v -> SPACINGS.map(__ -> v));
                                    ...
                                    RPAREN.then(line()).map(body ->
                                            (Expression) Block(
                                                    ...
                                                    While(
                                                            ...
                                                            Block(
                                                                    body,
                                                                    Assignment(name, add(symbol(name), integerLiteral(1)))
                                                            )
                                                    )
                                            )
                                    )
